    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.applications.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('start_review') ? 'is-invalid' : '' }}" type="text" name="start_review" id="start_review" value="{{ old('start_review') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('closed_date') ? 'is-invalid' : '' }}" type="text" name="closed_date" id="closed_date" value="{{ old('closed_date') }}">
