    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-applicantReviews">
                    <thead>
                        <tr>
                            <th width="10">
                    ...
                    <tbody>
                        @foreach($reviews as $key => $review)
                            <tr data-entry-id="{{ $review->id }}">
                                ...
                                <td>
                                    {{ $review->applicant->education_level ?? '' }}
                                </td>
                                <td>
                                    {{ $review->rate ?? '' }}
                                </td>
...
@endcan
  ...
  let table = $('.datatable-applicantReviews:not(.ajaxTable)').DataTable({ buttons: dtButtons })
