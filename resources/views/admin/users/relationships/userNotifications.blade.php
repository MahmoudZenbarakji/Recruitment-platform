    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-userNotifications">
                    <thead>
                        <tr>
                            <th width="10">
                            ...
                            <th>
                                {{ trans('cruds.notification.fields.is_read') }}
                            </th>
                            <th>
                                &nbsp;
                            </th>
                    ...
                    <tbody>
                        @foreach($notifications as $key => $notification)
                            <tr data-entry-id="{{ $notification->id }}">
                                ...
                                <td>
                                    <span style="display:none">{{ $notification->is_read ?? '' }}</span>
                                    <input type="checkbox" disabled="disabled" {{ $notification->is_read ? 'checked' : '' }}>
                                </td>
                                <td>
...
@endcan
  ...
  let table = $('.datatable-userNotifications:not(.ajaxTable)').DataTable({ buttons: dtButtons })
